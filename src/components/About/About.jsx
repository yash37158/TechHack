...
const About = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p class="Para mb-8 leading-relaxed">Tech Hack is a national level hackathon where tech enthusiasts, developers, and entrepreneurs collaborate to create innovative solutions for complex problems. The event fosters creativity and helps participants improve their coding skills and problem-solving abilities, while also providing an opportunity to compare their performance with others. 
